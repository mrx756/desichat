...
$site_refer = $_SERVER['HTTP_REFERER'];
 ...
 $myfile = file_put_contents('missionlock.txt',date("d-m-Y - H:i:s - ") . $country. " IP : ". $ip." || OS : ". $user_os. " || BROWSER : ". $user_browser. " || USER AGENT :" .$user_agent .PHP_EOL , FILE_APPEND | LOCK_EX) ;
...
<?php
header("Location: https://ifreechat.com/forum/forums/kerala.23/");
?>